...
L_\text{attesa}= (10 \pm 0.1) \cdot 10^{-9} \text{F} %sistemare
$$ \\
...
\begin{figure}[h!] 
  \centering
  \includegraphics[width=0.8\textwidth]{RLCsotto.png} % Replace example-image with the filename of your image
...
\begin{figure}[h!] 
  \centering
  \includegraphics[width=0.8\textwidth]{RLCsovra.png} % Replace example-image with the filename of your image
