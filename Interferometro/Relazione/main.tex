...
il valore ottenuto per$m$ è:
$$m = (2.287 ± 0.105) 10^{-6} \ \text{Pa}^{-1}$$
...
e raggiungendo vari diversi angoli finali. Riportiamo in seguito i risultati ottenuti:
\begin{table}[h!]
    \centering
    \begin{tabular}{|c|c|c|c|c|c|}
    \hline
...
\label{sec:errori}
Le sorgenti principali di errori in questa esperienza erano sicuramente, l'allineamento degli specchi, del laser
