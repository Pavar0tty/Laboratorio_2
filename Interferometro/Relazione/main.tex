...
In tal modo, la luce del fascio laser incide contro uno specchio divergente e entra nella cavità di Fabry-Perot,
di ampiezza $d$. Le riflessioni successive tra i due specchi formano la figura di interferenza sullo schermo, posto
...
Un'altra discussione importante riguarda gli angoli delle frange di interferenza. L'angolo $\theta$ è quello riportato
in figura \ref{fig:fabry_perot_scheda}.
...
Ci si può chiedere come misurare quest'angolo e soprattutto dove si trova il suo vertice. Abbiamo posto il vertice nel
fuoco della lente divergente e misurato la distanza tra tale fuoco e lo schermo. In questo modo, misurando in seguito
la distanza tra il centro della figura di interferenza e la frangia, è possibile calcolare l'angolo $\theta$ come 
l'arcotangente del rapporto tra le due distanze. In ogni caso, tali considerazioni sono state rilevanti solo per la 
prima parte dell'esperienza, in cui era richiesto di verificare la legge \ref{eq:fabry_perot} confrontando i valori di 
angoli attesi con quelli misurati. Per tutte le altre esperienze abbiamo potuto considerare il coseno dell'angolo 
pari a 1 perchè lo schermo si trova a grande distanza dalla sorgente puntiforme.\\

\subsection{Verifica della legge di interferenza}

Nella prima parte dell'esperienza abbiamo verificato la legge di interferenza, riportata in equazione
\ref{eq:fabry_perot}:
...
dove $d$ è la distanza tra i due specchi, $\theta$ è l'angolo di incidenza della luce e $N$ è l'ordine di interferenza.
...
Abbiamo perciò misurato il raggio dei cerchi di interferenza e calcolato così il coseno dell'angolo $\theta$, 
avendo un valore di distanza dello schermo dalla sorgente di $D = 1.375 m$. Successivamente abbiamo eseguito 
