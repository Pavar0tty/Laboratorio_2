...
La distanza dello schermo dalla sorgente è pari a $D = 1.375 m$, assumendo come punto sorgente il fuoco della lente 
(18mm). Successivamente abbiamo eseguito un'interpolazione tramite la legge \ref{eq:fabry_perot_cos}, mantenendo come 
...
Riportiamo i grafici ottenuti per ciascuna misurazione in figura \ref{fig:verifica_fabry_perot}:
...
Riportiamo nella tabella \ref{tab:dati_interpolazioni_FP} i valori ottenuti per i parametri $\delta_r$ e $d$ 
e i relativi errori, insiema ai valori di $\tilde{\chi}^2$ e p-value ottenuti dalle interpolazioni.
...
\begin{table}[h!]
    ...
    \hline
    \textbf{d1} & 0.00252 & 4.82e-07 & \textbf{d2} & 0.00254 & 4.83e-07 \\
    \textbf{delta1} & 5.01e+04 & 9.56 & \textbf{delta2} & 5.04e+04 & 9.58 \\
    \textbf{$\tilde{\chi}^2_1$} & 0.107 & \textbf{Pvalue 1:} 1 & \textbf{$\tilde{\chi}^2_2$} & 0.0398 & \textbf{Pvalue 2:} 1 \\
    \hline
    \multicolumn{3}{|c||}{\textbf{Interpolazione 3}} & \multicolumn{3}{c|}{\textbf{Interpolazione 4}} \\
    \hline
    \textbf{Parametro} & \textbf{Valore} & \textbf{Errore} & \textbf{Parametro} & \textbf{Valore} & \textbf{Errore} \\
    \hline
    \textbf{d3} & 0.00219 & 4.22e-07 & \textbf{d4} & 0.00255 & 4.84e-07 \\
    \textbf{delta3} & 4.34e+04 & 8.36 & \textbf{delta4} & 5.06e+04 & 9.60 \\
    \textbf{$\tilde{\chi}^2_3$} & 0.75 & \textbf{Pvalue 3:} 0.678 & \textbf{$\tilde{\chi}^2_4$} & 0.0756 & \textbf{Pvalue 4:} 1 \\
    \hline
    \end{tabular}
