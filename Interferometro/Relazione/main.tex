...
Gli errori riportati nella tabella sono stati calcolati con l'ooportuna formula di propagazione degli errori, riportiamo  inoltre
che per questi calcoli abbiamo utilizzato come valore di $\lambda$ la lunghezza d'onda del laser He-Ne $\lambda = \SI{632.8}{\nano\meter} \pm0.1$ aggiungere citazione.
