...
Successivamente, abbiamo ricavando la lunghezza d'onda del fascio dai dati campionati più frequentemente, con un passo minore, riportandoli nella figura di seguito \ref{fig:distanza_zoom}.
...
\ref{fig:wrong_pol}. Infatti per polarizzazione perpendicolare si può osservare una crescita di intensità attorno 
all'angolo di Brewster, anche se non in maniera vistosa. Nel nostro caso questo aumento si può osservare attorno 
all'angolo ottenuto dall'interpolazione. Il fatto che per due misurazioni diverse (polarizzazione parallela 
e perpendicolare) si sia ottenuto lo stesso risultato conferma la spiegazione di errore sistematico
